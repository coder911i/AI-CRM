...
export default function OwnerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { label: 'My Properties', icon: '🏠', href: '/owner/properties' },
    { label: 'Leads', icon: '👤', href: '/owner/leads' },
    { label: 'Visits', icon: '📅', href: '/owner/visits' },
    { label: 'Deals', icon: '💎', href: '/owner/deals' },
  ];
        ...
        <div className="sidebar-user">
          ...
          {!collapsed && (
            <div className="user-info">
              <span className="user-email">Owner Portal</span>
