...
exports.templates = {
    welcomeLead: (leadName, agentName, projectName) => ({
    ...
    visitConfirmation: (leadName, projectName, visitDate, mapsLink) => ({
    ...
    visitReminder24h: (leadName, projectName, visitDate) => ({
    ...
    visitReminder2h: (leadName, projectName, visitDate) => ({
    ...
    paymentDue: (buyerName, amount, dueDate, projectName, days) => ({
    ...
    bookingConfirmation: (buyerName, unitNo, projectName, amount) => ({
